...
const (
	CheckoutService_Checkout_FullMethodName = "/purchase.CheckoutService/Checkout"
)
...
func (UnimplementedCheckoutServiceServer) Checkout(context.Context, *CheckoutRequest) (*CheckoutResponse, error) {
...
var CheckoutService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "purchase.CheckoutService",
